<template>
	<view class="uv-drop-down-item" @click="clickHandler">
		<uv-text :text="label" :size="getTextStyle.size" :color="getTextStyle.color" lines="1" :custom-style="{marginRight: '10rpx', maxWidth}"></uv-text>
...
<script>
	 ...
	 * @property {String | Number} maxWidth 筛选项的最大宽度
	 */
	export default {
